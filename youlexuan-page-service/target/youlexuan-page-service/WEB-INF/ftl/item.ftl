            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <#if (imageList?size>0)>
                            <img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="400" height="300"/>
                        </#if>
                    </div>
                    <!--下方的缩略图-->
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="cart.html" target="_blank" class="sui-btn ng-click="addToCart()" btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
